...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://redcreativapro.com/blog/crear-cursos-online-con-ia'
  }
}
...
const jsonLd = {
  ...
  '@type': 'Article',
  headline: 'Cómo Crear Cursos Online con IA: De la Idea al Lanzamiento en 48 Horas',
  description: 'Estrategia completa para diseñar, estructurar y crear el contenido de tu curso online usando inteligencia artificial de forma eficiente.',
  author: {
    '@type': 'Person',
    name: 'Selamu',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://redcreativapro.com/blog/crear-cursos-online-con-ia'
  },
  keywords: 'crear cursos IA, infoproductos IA, educación online, diseño instruccional IA, lanzamiento cursos'
}
