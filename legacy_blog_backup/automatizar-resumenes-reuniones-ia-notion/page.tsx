...
export const metadata: Metadata = {
  ...
  description: '💡 Mejora convierte reuniones en resúmenes accionables con ia ✓ notion ★ plantilla de prompts incluida. ✨ ¡Paso a paso!',
  
  keywords: 'automatiza, resúmenes, reuniones, notion, [paso, paso], automatizar, resumenes, reuniones, notion',alternates: { canonical: 'https://redcreativa.pro/blog/automatizar-resumenes-reuniones-ia-notion' },
