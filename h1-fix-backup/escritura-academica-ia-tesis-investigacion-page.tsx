          ...
          <div className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl p-6 mb-8 border border-blue-100">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center">
                ...
                <span className="text-muted-foreground">1. IA para Investigación y Revisión Bibliográfica</span>
              </li>
              <li className="flex items-center">
                <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
                <span className="text-muted-foreground">2. Estructuración Automática de Tesis</span>
              </li>
              <li className="flex items-center">
                <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
                <span className="text-muted-foreground">3. Análisis de Datos con IA</span>
              </li>
              <li className="flex items-center">
                <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
                <span className="text-muted-foreground">4. Redacción de Papers Científicos</span>
              </li>
              <li className="flex items-center">
                <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
                <span className="text-muted-foreground">5. Herramientas Específicas para Academia</span>
              </li>
            </ul>
          </div>
