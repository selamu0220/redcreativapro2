...
export default function UsageStats() {
  ...
  if (error) {
    return (
      <div className="bg-zinc-900 border border-red-800 rounded-xl p-8">
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center">
        ...
        <button 
          onClick={fetchStats}
          className="px-4 py-2 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 text-white rounded-lg font-medium transition-all duration-300 flex items-center space-x-2"
        >
          <span>🔄</span>
      ...
      <div>
        <div className="flex items-center mb-6">
          ...
          <h3 className="text-xl font-semibold text-white">Total Histórico</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 text-center hover:border-zinc-700 transition-all duration-300">
            <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center mx-auto mb-4">
              <span className="text-white text-xl">✍️</span>
            </div>
            <div className="text-3xl font-bold text-white mb-2">{stats?.totalTextsGenerated?.toLocaleString() || '0'}</div>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 text-center hover:border-zinc-700 transition-all duration-300">
            ...
            <div className="text-3xl font-bold text-white mb-2">{stats?.totalEmailsSent?.toLocaleString() || '0'}</div>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 text-center hover:border-zinc-700 transition-all duration-300">
            ...
            <div className="text-3xl font-bold text-white mb-2">{stats?.totalPrompts?.toLocaleString() || '0'}</div>
