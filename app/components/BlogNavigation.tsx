 ...
 * BlogNavigation
 * 
 * A completely isolated navigation component for the Blog section.
 * STRICTLY NO AUTHENTICATION LOGIC OR KINDE DEPENDENCIES.
 * This ensures the blog never crashes due to auth provider issues.
 */
        ...
        <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
            <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                ...
                <Link href="/" className="flex items-center space-x-2 hover:opacity-90 transition-opacity">
                    ...
                    <span className="font-bold text-xl tracking-tight">Red Creativa Pro</span>
                    <Badge variant="outline" className="ml-2 font-mono text-[10px] uppercase tracking-wider">BLOG</Badge>
                </Link>
                ...
                <nav className="hidden md:flex items-center space-x-1">
                    ...
                    {/* Static Login Links - No Auth State Checks */}
