...
export async function POST(request: NextRequest) {
  try {
    ...
    const { message, selectedPrompt, userApiKey, history } = await request.json();
    ...
    console.error('Error en chat-prompts:', error);
    return NextResponse.json(
