...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://redcreativapro.com/blog/mejorar-textos-ia-gratis'
  }
}
...
const jsonLd = {
  ...
  '@type': 'Article',
  headline: 'Mejorar Textos con IA Gratis: Tu Herramienta de Optimización Online',
  description: 'Mejora tus textos con IA gratis online. Herramienta inteligente para optimizar escritura, corregir errores y mejorar estilo. ¡Prueba ahora sin costo!',
  author: {
    '@type': 'Person',
    name: 'Selamu',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://redcreativapro.com/blog/mejorar-textos-ia-gratis'
  },
  keywords: 'IA, Escritura, Productividad'
}
