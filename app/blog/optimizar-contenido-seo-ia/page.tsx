...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://redcreativapro.com/blog/optimizar-contenido-seo-ia'
  }
}
...
const jsonLd = {
  ...
  '@type': 'Article',
  headline: 'Optimizar Contenido SEO con IA: Estrategias Avanzadas 2025',
  description: 'Aprende a optimizar tu contenido para SEO usando inteligencia artificial. Herramientas y estrategias para mejorar el posicionamiento web.',
  author: {
    '@type': 'Person',
    name: 'Selamu',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://redcreativapro.com/blog/optimizar-contenido-seo-ia'
  },
  keywords: 'IA, Escritura, Productividad'
}
