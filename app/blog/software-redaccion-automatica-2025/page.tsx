...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://redcreativapro.com/blog/software-redaccion-automatica-2025'
  }
}
...
const jsonLd = {
  ...
  '@type': 'Article',
  headline: 'Software de Redacción Automática 2025: La Nueva Era de la Escritura',
  description: 'Descubre el mejor software de redacción automática 2025. Herramientas IA avanzadas para escribir contenido profesional automáticamente. ¡Prueba gratis!',
  author: {
    '@type': 'Person',
    name: 'Selamu',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://redcreativapro.com/blog/software-redaccion-automatica-2025'
  },
  keywords: 'IA, Escritura, Productividad'
}
