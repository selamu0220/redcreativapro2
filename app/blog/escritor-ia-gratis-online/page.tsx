...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://redcreativapro.com/blog/escritor-ia-gratis-online'
  }
}
...
const jsonLd = {
  ...
  '@type': 'Article',
  headline: 'Escritor IA Gratis Online: La Revolución de la Escritura Inteligente',
  description: 'Descubre el mejor escritor IA gratis online. Mejora tus textos, corrige gramática y optimiza contenido con inteligencia artificial. ¡Pruébalo ahora!',
  author: {
    '@type': 'Person',
    name: 'Selamu',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://redcreativapro.com/blog/escritor-ia-gratis-online'
  },
  keywords: 'IA, Escritura, Productividad'
}
