...
export const metadata: Metadata = {
  ...
  description: 'Guía práctica para escritores sobre cómo usar ChatGPT como asistente creativo. Prompts, técnicas de edición y mejores prácticas para autores.',
  keywords: 'ChatGPT para escritores, escritura creativa IA, asistente redacción, prompts para autores, creatividad aumentada',
  openGraph: {
    title: 'ChatGPT para Escritores: Cómo Potenciar tu Creatividad sin Perder tu Voz',
    description: 'Guía práctica para escritores sobre cómo usar ChatGPT como asistente creativo. Prompts, técnicas de edición y mejores prácticas para autores.',
    type: 'article',
  ...
  alternates: {
    canonical: 'https://redcreativapro.com/blog/chatgpt-para-escritores'
  }
}
...
const jsonLd = {
  ...
  '@type': 'Article',
  headline: 'ChatGPT para Escritores: Cómo Potenciar tu Creatividad sin Perder tu Voz',
  description: 'Guía práctica para escritores sobre cómo usar ChatGPT como asistente creativo. Prompts, técnicas de edición y mejores prácticas para autores.',
  author: {
    '@type': 'Person',
    name: 'Selamu',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://redcreativapro.com/blog/chatgpt-para-escritores'
  },
  keywords: 'ChatGPT para escritores, escritura creativa IA, asistente redacción, prompts para autores, creatividad aumentada'
}
        ...
        <div className="mb-8">
          ...
          <header className="mb-8">
            <div className="flex items-center gap-2 text-sm text-foreground mb-4">
              ...
              <span>•</span>
              <span>12 min min de lectura</span>
              <span>•</span>
              <span>5 de febrero de 2025</span>
            </div>
