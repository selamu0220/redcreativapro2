...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://redcreativapro.com/blog/herramientas-ia-escritura-2025'
  }
}
...
const jsonLd = {
  ...
  '@type': 'Article',
  headline: 'Las 15 mejores herramientas de IA para escritura en 2025',
  description: 'Revisión completa de las herramientas de inteligencia artificial más efectivas para crear contenido profesional, desde principiantes hasta expertos.',
  author: {
    '@type': 'Person',
    name: 'Selamu',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://redcreativapro.com/blog/herramientas-ia-escritura-2025'
  },
  keywords: 'IA, Escritura, Productividad'
}
