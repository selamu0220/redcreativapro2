        ...
        <div className="prose prose-lg max-w-none dark:prose-invert">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            {[
              ...
              { num: 3, title: 'Optimización', color: 'bg-black/50', text: 'Monitorea los resultados y ajusta la estrategia según los datos para maximizar el rendimiento continuo.' },
