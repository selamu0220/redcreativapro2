...
export const metadata: Metadata = {
  ...
  description: 'Descubre workflows de automatización para escritura con IA que pueden ahorrarte hasta 25 horas semanales. Guía práctica con ejemplos reales.',
...
const jsonLd = {
  ...
  dateModified: '2025-07-11T00:00:00.000Z',
  mainEntityOfPage: {
    '@type': 'WebPage',
