...
export const metadata: Metadata = {
  ...
  description: 'Aprende a automatizar completamente tus campañas de email marketing usando inteligencia artificial. Estrategias de personalización y segmentación avanzada.',
  keywords: 'email marketing IA, automatización email, marketing digital IA, personalización masiva, conversión email',
  openGraph: {
    title: 'Automatizar Email Marketing con IA: Guía Completa 2025',
    description: 'Aprende a automatizar completamente tus campañas de email marketing usando inteligencia artificial. Estrategias de personalización y segmentación avanzada.',
    type: 'article',
  ...
  alternates: {
    canonical: 'https://redcreativapro.com/blog/automatizar-email-marketing-con-ia'
  }
}
...
const jsonLd = {
  ...
  '@type': 'Article',
  headline: 'Automatizar Email Marketing con IA: Guía Completa 2025',
  description: 'Aprende a automatizar completamente tus campañas de email marketing usando inteligencia artificial. Estrategias de personalización y segmentación avanzada.',
  author: {
    '@type': 'Person',
    name: 'Selamu',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://redcreativapro.com/blog/automatizar-email-marketing-con-ia'
  },
  keywords: 'email marketing IA, automatización email, marketing digital IA, personalización masiva, conversión email'
}
