...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://redcreativapro.com/blog/personalizar-tono-voz-ia'
  }
}
...
const jsonLd = {
  ...
  '@type': 'Article',
  headline: 'Personalizar Tono de Voz con IA: Estrategias de Marca 2025',
  description: 'Aprende a personalizar el tono de voz de tu marca usando inteligencia artificial. Herramientas y estrategias para crear una identidad de marca consistente.',
  author: {
    '@type': 'Person',
    name: 'Selamu',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://redcreativapro.com/blog/personalizar-tono-voz-ia'
  },
  keywords: 'IA, Escritura, Productividad'
}
