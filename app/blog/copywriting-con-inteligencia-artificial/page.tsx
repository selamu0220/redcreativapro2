...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://redcreativapro.com/blog/copywriting-con-inteligencia-artificial'
  }
}
...
const jsonLd = {
  ...
  '@type': 'Article',
  headline: 'Copywriting con Inteligencia Artificial: Textos Persuasivos en Minutos',
  description: 'Domina el arte del copywriting asistido por IA. Cómo crear landing pages, anuncios y textos de venta que convierten usando modelos de lenguaje.',
  author: {
    '@type': 'Person',
    name: 'Selamu',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://redcreativapro.com/blog/copywriting-con-inteligencia-artificial'
  },
  keywords: 'copywriting IA, textos persuasivos, conversión marketing, landing pages IA, anuncios optimizados'
}
      ...
      <article className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="prose prose-lg max-w-none">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="text-blue-800">
                  Descubre las mejores estrategias, herramientas y técnicas para el copywriting. 
          ...
          <p className="text-lg text-gray-700 mb-6">
            el Copywriting representa una revolución en la forma de crear y optimizar contenido. 
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center">
            ...
            Cómo Implementar el Copywriting
          </h2>
          ...
          <p className="text-lg text-gray-700 mb-6">
            el Copywriting no es solo una tendencia, es el futuro de la creación de contenido. 
