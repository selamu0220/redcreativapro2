...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://redcreativapro.com/blog/mejores-prompts-ia-escritura'
  }
}
...
const jsonLd = {
  ...
  '@type': 'Article',
  headline: 'Los 50 mejores prompts de IA para escritura profesional',
  description: 'Colección completa de prompts probados para generar contenido de calidad con herramientas de inteligencia artificial. Copia y usa inmediatamente.',
  author: {
    '@type': 'Person',
    name: 'Selamu',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://redcreativapro.com/blog/mejores-prompts-ia-escritura'
  },
  keywords: 'IA, Escritura, Productividad'
}
