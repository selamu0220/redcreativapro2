...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Descubre las mejores técnicas y herramientas de inteligencia artificial para mejorar tu escritura profesional y crear contenido de calidad.',
    type: 'article',
    publishedTime: '2025-05-30T00:00:00.000Z',
    authors: ['Selamu'],
  ...
  alternates: {
    canonical: 'https://redcreativapro.com/blog/como-usar-ia-para-escribir-mejor'
  }
}
...
const jsonLd = {
  ...
  '@type': 'Article',
  headline: 'Cómo Usar IA para Escribir Mejor: Guía Completa 2025',
  description: 'Descubre las mejores técnicas y herramientas de inteligencia artificial para mejorar tu escritura profesional y crear contenido de calidad.',
  author: {
    '@type': 'Person',
    name: 'Selamu',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://redcreativapro.com/blog/como-usar-ia-para-escribir-mejor'
  },
  keywords: 'IA, Escritura, Productividad'
}
        ...
        <div className="mb-8">
          ...
          <header className="mb-8">
            <div className="flex items-center gap-2 text-sm text-foreground/80 mb-4">
              ...
              <span>•</span>
              <span>7 min min de lectura</span>
              <span>•</span>
