...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://redcreativapro.com/blog/ia-vs-redactor-humano'
  }
}
...
const jsonLd = {
  ...
  '@type': 'Article',
  headline: 'IA vs Redactor Humano: ¿Cuál elegir en 2025?',
  description: 'Comparativa detallada entre la escritura con IA y redactores humanos. Ventajas, desventajas y cuándo usar cada opción para tu negocio.',
  author: {
    '@type': 'Person',
    name: 'Selamu',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://redcreativapro.com/blog/ia-vs-redactor-humano'
  },
  keywords: 'IA, Escritura, Productividad'
}
