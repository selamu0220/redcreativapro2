    ...
    <>
      ...
      <ArticleWrapper>
        ...
        <nav className="flex items-center space-x-2 text-sm text-muted-foreground mb-6">
          ...
          <span>/</span>
          <span className="text-foreground font-medium">IA vs Redactor Humano: ¿Cuál... | Escritura Profesional 2025</span>
        </nav>
          <Link 
            href="/blog" 
          ...
          <header className="mb-8">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6 leading-tight">IA vs Redactor Humano: ¿Cuál elegir en 2025?
            </h1>
