...
export const metadata: Metadata = {
  ...
  description: 'Secuencia de nurturing por rol CISO con IA en español: educación, valor y activación.',
...
const articleJsonLd = {
  ...
  headline: 'Nurturing de seguridad para CISO con IA (B2B, español)',
  description: 'Secuencia por rol CISO: riesgo, caso de uso y activación con IA en español.',
  keywords: 'nurturing CISO español IA, seguridad B2B emails rol, secuencia por rol IA seguridad',
  ...
  mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://redcreativa.pro/blog/nurturing-seguridad-ciso-ia-espanol' },
  inLanguage: 'es-ES'
}

export default function NurturingCISOPage() {
  return (
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-8">
        ...
        <header className="mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6 leading-tight">Nurturing de seguridad para CISO con IA</h1>
          <p className="text-xl text-muted-foreground leading-relaxed">Secuencia por rol: riesgo, caso de uso y activación. Personaliza por sector y tamaño con IA en español.</p>
        </header>
