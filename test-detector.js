// Quick test script for AI detector - Updated to test user's complaint
// Run with: npx tsx test-detector.js

// Using dynamic import for ES module
async function main() {
    const { analyzeText } = await import('./app/lib/ai-detector.ts');
